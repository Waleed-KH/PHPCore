...
class MySQL
{
	 ...
	 *
	 * @return MySQL Returns the current instance.
	 */
	 ...
	 *
	 * @uses $MySQL->orderBy('id', 'desc')->orderBy('name', 'desc');
	 *
	...
	/**
	 * Method creates new MySQL object for a subquery generation
	 * 
	...
	/**
	 * Method returns a copy of a MySQL subquery object
	 *
	 * @return MySQL new MySQL object
	 */
	...
	/**
	 * Get where and what function was called for query stored in MySQL->trace
	 *
